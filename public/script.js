          ...
          for (var count = 0; count < data.data.length; count++) {
            html += `
                          <tr>
                              ...
                              <td><button type="button" class="btn btn-outline-info edit" data-id="`+ data.data[count].id + `">Edit</button>&nbsp;<button type="button" class="btn btn-outline-danger leave" data-id="` + data.data[count].id + `">Leave</button>&nbsp;<button type="button" class="btn btn-outline-danger delete" data-id="` + data.data[count].id + `">Delete</button></td>
                          </tr>
                          `;
          }
          $("input").val("");
          ...
          for (var count = 0; count < data.data.length; count++) {
            ...
            html += `
                        <tr>
                            ...
                            <td>`+ data.data[count].status + `</td>
                            <td><button type="button" class="btn btn-outline-info leaveedit" data-id="`+ data.data[count].leave_id + `">Edit</button>&nbsp;<button type="button" class="btn btn-outline-danger leavedelete" data-id="` + data.data[count].leave_id + `">Delete</button></td>
                        </tr>
                        `;
          }
          $("input").val("");
